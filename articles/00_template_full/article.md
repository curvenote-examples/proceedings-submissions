...
keypoints:
  - You may specify 1 to 3 keypoints for this template
  - These keypoints are complete sentences and less than or equal to 140 characters
  - They are specific to this template, so they will not appear in other exports plain
---
...
A number of eruptions were recorded since the colonization of the islands by Europeans in the late 1400s, these are summarized in @tbl:history.
...
From our analysis in @eq:timeline, we can see 3 different systems in play.
